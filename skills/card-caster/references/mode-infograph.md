...
Read `~/.claude/skills/card-caster/assets/infograph_template.html`
...
```bash
node ~/.claude/skills/card-caster/assets/capture.js /tmp/ljg_cast_infograph_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
