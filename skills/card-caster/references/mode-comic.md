...
Read `~/.claude/skills/card-caster/assets/comic_template.html`
...
```bash
node ~/.claude/skills/card-caster/assets/capture.js /tmp/ljg_cast_comic_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
